  ...
  return (
    <div className={`h-full ${isSidebarOpen ? 'w-64' : 'w-20'} bg-white shadow-lg p-4 transition-all duration-300 `}>
      <div className="flex justify-between items-center mb-6">
        <h2 className={`text-xl font-semibold ${isSidebarOpen ? 'block' : 'hidden'}`}>Admin Panel</h2>
      ...
      <ul className="space-y-2">
        <li className="flex items-center justify-between p-2 hover:bg-gray-100 rounded cursor-pointer" onClick={handleIconClick}>
          <div className="flex items-center">
            ...
            <span className={`${isSidebarOpen ? 'block' : 'hidden'} ml-3`}><a href='/admin/dashboard'>Dashboard</a></span>
          </div>
        </li>
        ...
        <li className="flex items-center justify-between p-2 hover:bg-gray-100 rounded cursor-pointer" onClick={handleIconClick}>
          <div className="flex items-center">
            ...
            <span className={`${isSidebarOpen ? 'block' : 'hidden'} ml-3`}>Inbox</span>
          </div>
          {isSidebarOpen && (
        ...
        <li className="flex items-center p-2 hover:bg-gray-100 rounded cursor-pointer" onClick={handleIconClick}>
          ...
          <span className={`${isSidebarOpen ? 'block' : 'hidden'} ml-3`}><a href="/admin/profile">Profile </a></span>
        </li>
        ...
        <li className="flex items-center p-2 hover:bg-gray-100 rounded cursor-pointer" onClick={handleIconClick}>
          ...
          <span className={`${isSidebarOpen ? 'block' : 'hidden'} ml-3`}> <button onClick={handLog}>Log Out</button></span>
        </li>
      </ul>
    </div>
  );
