...
import AccountOp from './Account-options';
...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    fetchCartItems();
}, [showCart]); // Ensure useEffect runs when auth.id changes
  
  const handleCartClick = () => {
    setShowCart(prevState => !prevState); // Toggle the cart display state
  };
  // const handleCartClick = (e) => {
  //   e.preventDefault(); // Prevent default behavior if needed
  //   setShowCart(true); // Toggle the cart display state
  ...
  return (
    <div className="bg-white">
      ...
      <Transition show={open}>
        <Dialog className="relative z-49999990 lg:hidden" onClose={setOpen}>
          <TransitionChild
              ...
              <DialogPanel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    <img
                      src="https://img.icons8.com/color/48/morocco.png" 
                      alt=""
...
{/*------------------------------ END OF MOBILE ------------------------ */}
      <header className="relative bg-white z-99999999">
        <p className="flex h-10 items-center justify-center bg-gray-300 px-4 text-sm font-medium text-black sm:px-6  lg:px-8">
          Join Us and Earn Up to 10k MAD a month &nbsp; <a href="/portail"><u>Join Now</u></a>
        </p>
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  <span className="sr-only">ShoppeLux</span>
                  <img
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <AccountOp name={auth.FullName}></AccountOp>
                  </a>
      ...
      <div className="group -m-2 flex items-center p-2">
        <ShoppingBagIcon
          ...
          aria-hidden="true"
          onClick={handleCartClick} // Handle click event on icon
        />
        {isAuthenticated &&
